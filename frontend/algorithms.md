...
![algorithms-roadmap.png](images/algorithms-roadmap.png)
...
Список задач и материалов если собеседование скоро и времени совсем мало. Для начала прочитай блок **Как правильно готовиться** (см. выше).
